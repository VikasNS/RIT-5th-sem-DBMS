...
QUANTITY NUMBER(2),
ShipDate DATE,
CONSTRAINT pk_pno_wno PRIMARY KEY (PNO,WHO),
...
INSERT INTO SHIPMENT(PNO,WHO,QUANTITY,ShipDate) VALUES(8,1,22,TO_DATE('27-NOV-2011','DD-MON-YYYY'));
INSERT INTO SHIPMENT(PNO,WHO,QUANTITY,ShipDate) VALUES(8,2,22,TO_DATE('27-NOV-2011','DD-MON-YYYY'));


SELECT WNAME FROM WAREHOUSE WHERE WHO IN (SELECT WHO FROM SHIPMENT WHERE PNO IN (SELECT PNO FROM PART WHERE COLOUR = 'Red'));
SELECT PNO FROM SHIPMENT GROUP BY PNO HAVING COUNT(PNO)=(SELECT COUNT(*) FROM WAREHOUSE);
